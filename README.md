...
This project presents a real-time heart rate monitoring system built using a pulse sensor and an esp32 microcontroller. It measures the user’s heart rate (BPM - Beats Per Minute) and displays the waveform on screen .
---
* FEATURES -
